...
const Team = () => {
  ...
  const members = [
    {
      name: "Artisan Tea",
      role: "Handcrafted Aromatic Blend",
      img: image1,
      intro: "Experience the perfect harmony of flavors with our premium tea blends, steeped to perfection and served with care.",
      description: (
        <div className="text-gray-300 text-lg mb-6">
          ...
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              { name: "Spring Water", desc: "Pure and mineral-rich" },
              { name: "Organic Milk", desc: "Creamy and fresh" },
              { name: "Cane Sugar", desc: "Natural sweetener" },
              { name: "Assam Black Tea", desc: "Full-bodied leaves" },
              { name: "Cardamom Infusion", desc: "Elaichi-spiced option" }
            ].map((item, index) => (
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16 mt-8">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Steeped to perfection - our signature tea experience
          </p>
        </div>
