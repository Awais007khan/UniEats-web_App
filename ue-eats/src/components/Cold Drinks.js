...
const Team = () => {
  ...
  const members = [
    {
      name: "Premium Cold Drinks",
      role: "Handcrafted Refreshing Selection",
      img: image1,
      intro: "Experience the perfect chill with our premium selection of cold drinks, served at the ideal temperature for maximum refreshment.",
      description: (
        <div className="text-gray-300 text-lg mb-6">
          <h4 className="text-2xl font-semibold text-orange-400 mb-4 border-b border-orange-400 pb-2">Featured Brands:</h4>
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              { name: "Coca-Cola", desc: "Classic cola taste" },
              { name: "Mirinda", desc: "Fruity orange flavor" },
              { name: "Pepsi", desc: "The choice of new generation" },
              { name: "Fanta", desc: "Sparkling orange drink" },
              { name: "Sprite", desc: "Lemon-lime refreshment" },
              { name: "Sting", desc: "Energy boosting drink" },
              { name: "Mountain Dew", desc: "Citrus charged soda" },
              { name: "Gourmet", desc: "Premium local selection" }
            ].map((item, index) => (
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16 mt-8">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Ice-cold refreshment - our premium beverage selection
          </p>
        </div>
