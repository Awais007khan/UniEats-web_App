...
const Team = () => {
  ...
  const members = [
    {
      name: "Gourmet Samosa",
      role: "Handcrafted Spiced Delight",
      img: image1,
      intro: "Experience the perfect blend of spices with our premium samosas, freshly fried to golden perfection and served with signature chutneys.",
      description: (
        <div className="text-gray-300 text-lg mb-6">
          ...
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              { name: "Golden Potatoes", desc: "Mashed to perfection" },
              { name: "Caramelized Onions", desc: "Sweet and savory" },
              { name: "Fresh Green Chilies", desc: "Perfect heat balance" },
              { name: "Artisan Spice Blend", desc: "Cumin, coriander, paprika" },
              { name: "Organic Vinegar", desc: "For tangy notes" },
              { name: "Himalayan Salt", desc: "Mineral-rich seasoning" },
              { name: "House Pickles", desc: "Crunchy accompaniment" },
              { name: "Truffle Mayo", desc: "Gourmet dipping sauce" },
              { name: "Mint Chutney", desc: "Fresh herb blend" },
              { name: "Organic Fried Egg", desc: "Optional protein boost" }
            ].map((item, index) => (
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16 mt-8">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Freshly fried to perfection - our signature samosa experience
          </p>
        </div>
