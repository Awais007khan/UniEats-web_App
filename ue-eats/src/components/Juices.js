  ...
  const members = [
    {
      ...
      img: image1,
      intro: "Experience the perfect refreshment with our premium selection of juices, made from the finest fruits and served chilled.",
      description: (
        <div className="text-gray-300 text-lg mb-6">
          ...
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              { name: "Slice", desc: "Classic mango delight" },
              { name: "Fruiti", desc: "Vibrant fruit flavors" },
              { name: "Nestle", desc: "Mango, apple, guava varieties" },
              { name: "Real Fruit", desc: "100% natural juices" }
            ].map((item, index) => (
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16 mt-8">
          <h2 className="text-5xl md:text-6xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-orange-400 to-yellow-300">
            Fruitful Refreshment
          </h2>
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Nature's sweetness - our premium juice selection
          </p>
        </div>
