...
const Team = () => {
  ...
  const members = [
    {
      name: "Classic Burger",
      role: "Handcrafted Juicy Delight",
      img: image1,
      intro: "Experience the perfect harmony of flavors with our classic burger, made with premium ingredients and served with love.",
      description: (
        <div className="text-gray-300 text-lg mb-6">
          ...
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              { name: "Fresh Lettuce", desc: "Crisp and refreshing" },
              { name: "Vine Tomatoes", desc: "Juicy and ripe" },
              { name: "Red Onions", desc: "Thinly sliced" },
              { name: "Aged Cheddar", desc: "Sharp and flavorful" },
              { name: "House Sauce", desc: "Special blend" },
              { name: "Himalayan Salt", desc: "Mineral-rich seasoning" },
              { name: "Premium Oil", desc: "For perfect searing" }
            ].map((item, index) => (
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16 mt-8">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Juicy perfection - our signature burger experience
          </p>
        </div>
