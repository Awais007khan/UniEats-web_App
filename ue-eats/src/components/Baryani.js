...
const Team = () => {
  ...
  const members = [
    {
      name: "Royal Biryani",
      role: "Handcrafted Aromatic Delight",
      img: image1,
      intro: "Experience the perfect harmony of spices with our premium biryani, slow-cooked to perfection and served with care.",
      description: (
        <div className="text-gray-300 text-lg mb-6">
          ...
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              { name: "Basmati Rice", desc: "Long-grain aromatic variety" },
              { name: "Tender Chicken", desc: "Farm-raised and fresh" },
              { name: "Hung Yogurt", desc: "Creamy and rich" },
              { name: "Vine Tomatoes", desc: "Fresh and tangy" },
              { name: "Caramelized Onions", desc: "Slow-cooked sweetness" },
              { name: "Fresh Ginger", desc: "Aromatic and pungent" },
              { name: "Green Chilies", desc: "Perfect heat balance" },
              { name: "Lemon Wedges", desc: "Citrus accent" },
              { name: "Garden Salad", desc: "Fresh accompaniment" },
              { name: "Mint Chutney", desc: "Cooling contrast" }
            ].map((item, index) => (
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16 mt-8">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Slow-cooked to perfection - our signature biryani experience
          </p>
        </div>
