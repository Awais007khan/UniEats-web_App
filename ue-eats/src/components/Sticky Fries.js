...
const Team = () => {
  ...
  const members = [
    {
      name: "Gourmet Sticky Fries",
      role: "Handcrafted Crispy Delight",
      img: image1,
      intro: "Experience the perfect crunch with our premium sticky fries, coated in a special glaze and served with signature dipping sauces.",
      description: (
        <div className="text-gray-300 text-lg mb-6">
          ...
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              { name: "Golden Potatoes", desc: "Hand-cut for perfect crisp" },
              { name: "Special Glaze", desc: "Secret sticky coating" },
              { name: "Truffle Salt", desc: "Gourmet seasoning" },
              { name: "Parmesan Cheese", desc: "Aged for flavor" },
              { name: "Garlic Aioli", desc: "Creamy dipping sauce" },
              { name: "Spicy Ketchup", desc: "House-made blend" }
            ].map((item, index) => (
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16 mt-8">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Perfectly glazed - our signature sticky fries experience
          </p>
        </div>
