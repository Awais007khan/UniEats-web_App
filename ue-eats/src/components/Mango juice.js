  ...
  const members = [
    {
      ...
      role: "Handcrafted Refreshing Delight",
      img: image1,
      intro: "Experience the perfect tropical escape with our premium mango juice, made from the finest ripe mangoes and served chilled.",
      description: (
        <div className="text-gray-300 text-lg mb-6">
          ...
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              { name: "Alphonso Mangoes", desc: "The king of mango varieties" },
              { name: "Filtered Water", desc: "Pure and clean" },
              { name: "Organic Milk", desc: "Optional creamy version" },
              { name: "Cane Sugar", desc: "Natural sweetener" },
              { name: "Cardamom", desc: "Elaichi for aromatic touch" },
              { name: "Ice Cubes", desc: "Served perfectly chilled" }
            ].map((item, index) => (
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16 mt-8">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Freshly squeezed perfection - our signature mango experience
          </p>
        </div>
