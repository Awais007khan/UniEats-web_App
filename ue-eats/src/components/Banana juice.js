  ...
  const members = [
    {
      ...
      role: "Handcrafted Creamy Delight",
      img: image1,
      intro: "Experience the perfect tropical blend with our premium banana smoothie, made from the ripest bananas and served chilled to perfection.",
      description: (
        <div className="text-gray-300 text-lg mb-6">
          ...
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              { name: "Ripe Bananas", desc: "Sweet and creamy base" },
              { name: "Organic Cane Sugar", desc: "Natural sweetness" },
              { name: "Whole Milk", desc: "Creamy texture" },
              { name: "Artisan Ice Cubes", desc: "Perfectly chilled" },
              { name: "Whipped Cream", desc: "Luxurious topping" },
              { name: "Fresh Citrus", desc: "Lime or lemon for tang" }
            ].map((item, index) => (
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16 mt-8">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Creamy perfection - our signature banana smoothie experience
          </p>
        </div>
