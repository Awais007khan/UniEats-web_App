...
const Team = () => {
  ...
  const members = [
    {
      name: "Gourmet Fries",
      role: "Handcrafted Crispy Delight",
      img: image1,
      intro: "Experience the perfect crunch with our artisanal fries, crafted from premium potatoes and served with exquisite dipping sauces.",
      description: (
        <div className="text-gray-300 text-lg mb-6">
          ...
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              { name: "Russet Potatoes", desc: "Hand-cut daily for freshness" },
              { name: "Avocado Oil", desc: "High-heat cooking oil" },
              { name: "Truffle Salt", desc: "Gourmet seasoning" },
              { name: "Housemade Sour Cream", desc: "Cultured daily" },
              { name: "Aioli Mayonnaise", desc: "Garlic-infused" },
              { name: "Heirloom Ketchup", desc: "Sweet and tangy" },
  ...
  return (
    <section id="team" className="pt-32 pb-16 bg-gray-900 min-h-screen"> {/* Increased top padding */}
      <div className="container mx-auto px-4">
        {/* Main Title with Gradient - Added mt-8 for more spacing */}
        <div className="text-center mb-16 mt-8">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Golden, crispy, and irresistibly delicious - our signature fries
          </p>
        </div>
