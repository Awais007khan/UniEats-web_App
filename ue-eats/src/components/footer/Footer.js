  ...
  return (
    <footer className="bg-gradient-to-b from-gray-900 to-gray-800 text-white pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="bg-gray-700 hover:bg-sky-400 p-3 rounded-full transition-all duration-300 transform hover:-translate-y-1">
                <FaTwitter className="text-white" />
              </a>
              <a href="#" className="bg-gray-700 hover:bg-pink-600 p-3 rounded-full transition-all duration-300 transform hover:-translate-y-1">
                <FaInstagram className="text-white" />
              </a>
              <a href="#" className="bg-gray-700 hover:bg-blue-700 p-3 rounded-full transition-all duration-300 transform hover:-translate-y-1">
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={index}>
                  ...
                  >
                    <FiArrowRight className="mr-2 opacity-0 group-hover:opacity-100 transition-all duration-300" />
                    <span>{item.name}</span>
                  </a>
                </li>
              ))}
          ...
          <div className="space-y-6">
            ...
            <form className="space-y-3">
              <input 
                ...
                className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-white placeholder-gray-400 transition-all duration-300"
              />
              <button 
                type="submit" 
                className="w-full bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-medium py-3 px-6 rounded-lg transition-all duration-300 transform hover:scale-[1.02] shadow-lg hover:shadow-xl"
              >
                Subscribe
              </button>
            </form>
      ...
      <div className="absolute bottom-0 left-0 right-0 overflow-hidden pointer-events-none">
        <div className="absolute bottom-20 left-10 w-4 h-4 rounded-full bg-blue-500 opacity-20 animate-pulse"></div>
        <div className="absolute bottom-40 right-20 w-6 h-6 rounded-full bg-purple-500 opacity-20 animate-pulse" style={{ animationDelay: '0.5s' }}></div>
        <div className="absolute bottom-10 right-1/4 w-3 h-3 rounded-full bg-blue-400 opacity-20 animate-pulse" style={{ animationDelay: '1s' }}></div>
      </div>
    </footer>
  );
}
